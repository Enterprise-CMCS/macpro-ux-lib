...
*/
    ...
    15: [
      function (require, module, exports) {
        ...
        var LINK = "."
          .concat(PREFIX, "-show-password, .")
          .concat(PREFIX, "-show-multipassword");
    ...
    16: [
      function (require, module, exports) {
        ...
        var ACCORDION = "."
          ...
          .concat(PREFIX, "-accordion--bordered");
        ...
        var toggleButton = function toggleButton(button, expanded) {
          ...
          if (!accordion) {
            throw new Error(
              "".concat(BUTTON, " is missing outer ").concat(ACCORDION)
            );
          }
    ...
    18: [
      function (require, module, exports) {
        ...
        var MESSAGE_INVALID_CLASS = "".concat(
          PREFIX,
          "-character-count__message--invalid"
        );
        /**
        ...
        var getCharacterCountElements = function getCharacterCountElements(
          inputEl
        ) {
          ...
          if (!characterCountEl) {
            throw new Error(
              "".concat(INPUT, " is missing outer ").concat(CHARACTER_COUNT)
            );
          }
          ...
          if (!messageEl) {
            throw new Error(
              "".concat(CHARACTER_COUNT, " is missing inner ").concat(MESSAGE)
            );
          }
    ...
    19: [
      function (require, module, exports) {
        ...
        var CLEAR_INPUT_BUTTON_CLASS = "".concat(
          COMBO_BOX_CLASS,
          "__clear-input"
        );
        var CLEAR_INPUT_BUTTON_WRAPPER_CLASS = "".concat(
          CLEAR_INPUT_BUTTON_CLASS,
          "__wrapper"
        );
        var INPUT_BUTTON_SEPARATOR_CLASS = "".concat(
          COMBO_BOX_CLASS,
          "__input-button-separator"
        );
        var TOGGLE_LIST_BUTTON_CLASS = "".concat(
          COMBO_BOX_CLASS,
          "__toggle-list"
        );
        var TOGGLE_LIST_BUTTON_WRAPPER_CLASS = "".concat(
        ...
        var LIST_OPTION_FOCUSED_CLASS = "".concat(
          LIST_OPTION_CLASS,
          "--focused"
        );
        var LIST_OPTION_SELECTED_CLASS = "".concat(
          LIST_OPTION_CLASS,
          "--selected"
        );
        ...
        var getComboBoxContext = function getComboBoxContext(el) {
          ...
          var isPristine = comboBoxEl.classList.contains(
        ...
        var enhanceComboBox = function enhanceComboBox(_comboBoxEl) {
          ...
          var selectLabel = document.querySelector(
            'label[for="'.concat(selectId, '"]')
          );
          ...
          if (
            !selectLabel ||
            !selectLabel.matches('label[for="'.concat(selectId, '"]'))
          ) {
            throw new Error(
              ""
                .concat(COMBO_BOX, " for ")
                .concat(
                  selectId,
                  ' is either missing a label or a "for" attribute'
                )
            );
          } else {
          ...
          selectEl.id = "";
          selectEl.value = "";
          ["required", "aria-label", "aria-labelledby"].forEach(function (
            name
          ) {
          ...
          additionalAttributes.forEach(function (attr) {
            return Object.keys(attr).forEach(function (key) {
              var value = Sanitizer.escapeHTML(
                _templateObject ||
          ...
          comboBoxEl.insertAdjacentHTML(
            ...
            Sanitizer.escapeHTML(
              ...
              CLEAR_INPUT_BUTTON_WRAPPER_CLASS,
              CLEAR_INPUT_BUTTON_CLASS,
              INPUT_BUTTON_SEPARATOR_CLASS,
              TOGGLE_LIST_BUTTON_WRAPPER_CLASS,
              TOGGLE_LIST_BUTTON_CLASS,
              listId,
              LIST_CLASS,
              listIdLabel,
        ...
        var displayList = function displayList(el) {
          ...
          var regex = generateDynamicRegExp(
            filter,
            inputValue,
            comboBoxEl.dataset
          );
          ...
          noResults.setAttribute(
            "class",
            "".concat(LIST_OPTION_CLASS, "--no-results")
          );
          ...
          statusEl.textContent = numOptions
            ? ""
                .concat(numOptions, " result")
                .concat(numOptions > 1 ? "s" : "", " available.")
            : "No results.";
          var itemToFocus;
        ...
        var handleDownFromListOption = function handleDownFromListOption(
          event
        ) {
        ...
        var handleEnterFromListOption = function handleEnterFromListOption(
          event
        ) {
          selectItem(event.target);
          event.preventDefault();
        ...
        var handleMouseover = function handleMouseover(listOptionEl) {
          var isCurrentlyFocused = listOptionEl.classList.contains(
            LIST_OPTION_FOCUSED_CLASS
          );
        ...
        var comboBox = behavior(
          ((_behavior = {}),
          _defineProperty(
            _behavior,
            CLICK,
            ((_CLICK = {}),
            _defineProperty(_CLICK, INPUT, function () {
          ...
          _defineProperty(
            _behavior,
            "focusout",
            _defineProperty({}, COMBO_BOX, function (event) {
          ...
          _defineProperty(
            _behavior,
            "input",
            _defineProperty({}, INPUT, function () {
          ...
          _defineProperty(
            _behavior,
            "mouseover",
            _defineProperty({}, LIST_OPTION, function () {
    ...
    20: [
      function (require, module, exports) {
        ...
        var DATE_PICKER_WRAPPER_CLASS = "".concat(
          DATE_PICKER_CLASS,
          "__wrapper"
        );
        var DATE_PICKER_INITIALIZED_CLASS = "".concat(
          DATE_PICKER_CLASS,
          "--initialized"
        );
        var DATE_PICKER_ACTIVE_CLASS = "".concat(DATE_PICKER_CLASS, "--active");
        var DATE_PICKER_INTERNAL_INPUT_CLASS = "".concat(
          DATE_PICKER_CLASS,
          "__internal-input"
        );
        var DATE_PICKER_EXTERNAL_INPUT_CLASS = "".concat(
          DATE_PICKER_CLASS,
          "__external-input"
        );
        var DATE_PICKER_BUTTON_CLASS = "".concat(DATE_PICKER_CLASS, "__button");
        var DATE_PICKER_CALENDAR_CLASS = "".concat(
          DATE_PICKER_CLASS,
          "__calendar"
        );
        var DATE_PICKER_STATUS_CLASS = "".concat(DATE_PICKER_CLASS, "__status");
        var CALENDAR_DATE_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__date"
        );
        var CALENDAR_DATE_FOCUSED_CLASS = "".concat(
          CALENDAR_DATE_CLASS,
          "--focused"
        );
        var CALENDAR_DATE_SELECTED_CLASS = "".concat(
          CALENDAR_DATE_CLASS,
          "--selected"
        );
        var CALENDAR_DATE_PREVIOUS_MONTH_CLASS = "".concat(
          CALENDAR_DATE_CLASS,
          "--previous-month"
        );
        var CALENDAR_DATE_CURRENT_MONTH_CLASS = "".concat(
          CALENDAR_DATE_CLASS,
          "--current-month"
        );
        var CALENDAR_DATE_NEXT_MONTH_CLASS = "".concat(
          CALENDAR_DATE_CLASS,
          "--next-month"
        );
        var CALENDAR_DATE_RANGE_DATE_CLASS = "".concat(
          CALENDAR_DATE_CLASS,
          "--range-date"
        );
        var CALENDAR_DATE_TODAY_CLASS = "".concat(
          CALENDAR_DATE_CLASS,
          "--today"
        );
        var CALENDAR_DATE_RANGE_DATE_START_CLASS = "".concat(
          CALENDAR_DATE_CLASS,
          "--range-date-start"
        );
        var CALENDAR_DATE_RANGE_DATE_END_CLASS = "".concat(
          CALENDAR_DATE_CLASS,
          "--range-date-end"
        );
        var CALENDAR_DATE_WITHIN_RANGE_CLASS = "".concat(
          CALENDAR_DATE_CLASS,
          "--within-range"
        );
        var CALENDAR_PREVIOUS_YEAR_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__previous-year"
        );
        var CALENDAR_PREVIOUS_MONTH_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__previous-month"
        );
        var CALENDAR_NEXT_YEAR_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__next-year"
        );
        var CALENDAR_NEXT_MONTH_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__next-month"
        );
        var CALENDAR_MONTH_SELECTION_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__month-selection"
        );
        var CALENDAR_YEAR_SELECTION_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__year-selection"
        );
        var CALENDAR_MONTH_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__month"
        );
        var CALENDAR_MONTH_FOCUSED_CLASS = "".concat(
          CALENDAR_MONTH_CLASS,
          "--focused"
        );
        var CALENDAR_MONTH_SELECTED_CLASS = "".concat(
          CALENDAR_MONTH_CLASS,
          "--selected"
        );
        var CALENDAR_YEAR_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__year"
        );
        var CALENDAR_YEAR_FOCUSED_CLASS = "".concat(
          CALENDAR_YEAR_CLASS,
          "--focused"
        );
        var CALENDAR_YEAR_SELECTED_CLASS = "".concat(
          CALENDAR_YEAR_CLASS,
          "--selected"
        );
        var CALENDAR_PREVIOUS_YEAR_CHUNK_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__previous-year-chunk"
        );
        var CALENDAR_NEXT_YEAR_CHUNK_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__next-year-chunk"
        );
        var CALENDAR_DATE_PICKER_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__date-picker"
        );
        var CALENDAR_MONTH_PICKER_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__month-picker"
        );
        var CALENDAR_YEAR_PICKER_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__year-picker"
        );
        var CALENDAR_TABLE_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__table"
        );
        var CALENDAR_ROW_CLASS = "".concat(DATE_PICKER_CALENDAR_CLASS, "__row");
        var CALENDAR_CELL_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__cell"
        );
        var CALENDAR_CELL_CENTER_ITEMS_CLASS = "".concat(
          CALENDAR_CELL_CLASS,
          "--center-items"
        );
        var CALENDAR_MONTH_LABEL_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__month-label"
        );
        var CALENDAR_DAY_OF_WEEK_CLASS = "".concat(
          DATE_PICKER_CALENDAR_CLASS,
          "__day-of-week"
        );
        var DATE_PICKER = ".".concat(DATE_PICKER_CLASS);
        var DATE_PICKER_BUTTON = ".".concat(DATE_PICKER_BUTTON_CLASS);
        var DATE_PICKER_INTERNAL_INPUT = ".".concat(
          DATE_PICKER_INTERNAL_INPUT_CLASS
        );
        var DATE_PICKER_EXTERNAL_INPUT = ".".concat(
          DATE_PICKER_EXTERNAL_INPUT_CLASS
        );
        var DATE_PICKER_CALENDAR = ".".concat(DATE_PICKER_CALENDAR_CLASS);
        var DATE_PICKER_STATUS = ".".concat(DATE_PICKER_STATUS_CLASS);
        var CALENDAR_DATE = ".".concat(CALENDAR_DATE_CLASS);
        var CALENDAR_DATE_FOCUSED = ".".concat(CALENDAR_DATE_FOCUSED_CLASS);
        var CALENDAR_DATE_CURRENT_MONTH = ".".concat(
        ...
        var CALENDAR_MONTH_SELECTION = ".".concat(
          CALENDAR_MONTH_SELECTION_CLASS
        );
        var CALENDAR_MONTH = ".".concat(CALENDAR_MONTH_CLASS);
        var CALENDAR_YEAR = ".".concat(CALENDAR_YEAR_CLASS);
        var CALENDAR_PREVIOUS_YEAR_CHUNK = ".".concat(
          CALENDAR_PREVIOUS_YEAR_CHUNK_CLASS
        );
        var CALENDAR_NEXT_YEAR_CHUNK = ".".concat(
          CALENDAR_NEXT_YEAR_CHUNK_CLASS
        );
        ...
        var DATE_PICKER_FOCUSABLE = processFocusableSelectors(
        ...
        var MONTH_PICKER_FOCUSABLE = processFocusableSelectors(
          CALENDAR_MONTH_FOCUSED
        );
        var YEAR_PICKER_FOCUSABLE = processFocusableSelectors(
        ...
        var keepDateWithinMonth = function keepDateWithinMonth(
          dateToCheck,
          month
        ) {
        ...
        var keepDateBetweenMinAndMax = function keepDateBetweenMinAndMax(
          date,
          minDate,
          maxDate
        ) {
        ...
        var isDateWithinMinAndMax = function isDateWithinMinAndMax(
          date,
          minDate,
          maxDate
        ) {
        ...
        var isDatesMonthOutsideMinOrMax = function isDatesMonthOutsideMinOrMax(
          date,
          minDate,
          maxDate
        ) {
        ...
        var isDatesYearOutsideMinOrMax = function isDatesYearOutsideMinOrMax(
          date,
          minDate,
          maxDate
        ) {
              ...
              if (!Number.isNaN(parsed)) {
                ...
                if (adjustDate) {
                  ...
                  if (yearStr.length < 3) {
                    ...
                    var currentYearStub =
                      currentYear -
                      (currentYear % Math.pow(10, yearStr.length));
        ...
        var getDatePickerContext = function getDatePickerContext(el) {
          ...
          var internalInputEl = datePickerEl.querySelector(
            DATE_PICKER_INTERNAL_INPUT
          );
          var externalInputEl = datePickerEl.querySelector(
        ...
        var renderCalendar = function renderCalendar(el, _dateToDisplay) {
          ...
          var generateDateHtml = function generateDateHtml(dateToRender) {
            ...
            var tabindex = "-1";
            var isDisabled = !isDateWithinMinAndMax(
              dateToRender,
              minDate,
              maxDate
            );
          ...
          var datePickerCalendarContainer =
        ...
        var toggleCalendar = function toggleCalendar(el) {
          ...
          if (calendarEl.hidden) {
            var dateToDisplay = keepDateBetweenMinAndMax(
        ...
        var displayMonthSelection = function displayMonthSelection(
          el,
          monthToDisplay
        ) {
          ...
          var months = MONTH_LABELS.map(function (month, index) {
            ...
            var isDisabled = isDatesMonthOutsideMinOrMax(
              monthToCheck,
              minDate,
              maxDate
            );
        ...
        var displayYearSelection = function displayYearSelection(
          el,
          yearToDisplay
        ) {
          ...
          var prevYearChunkDisabled = isDatesYearOutsideMinOrMax(
            setYear(calendarDate, yearToChunk - 1),
            minDate,
            maxDate
          );
          var nextYearChunkDisabled = isDatesYearOutsideMinOrMax(
          ...
          while (years.length < YEAR_CHUNK) {
            var isDisabled = isDatesYearOutsideMinOrMax(
          ...
          previousYearsBtn.setAttribute(
            "aria-label",
            "Navigate back ".concat(YEAR_CHUNK, " years")
          );
          ...
          previousYearsBtn.innerHTML = Sanitizer.escapeHTML(
            _templateObject4 ||
              (_templateObject4 = _taggedTemplateLiteral(["&nbsp"]))
          ); // create next button
          ...
          nextYearsBtn.setAttribute(
            "aria-label",
            "Navigate forward ".concat(YEAR_CHUNK, " years")
          );
          ...
          nextYearsBtn.innerHTML = Sanitizer.escapeHTML(
            _templateObject5 ||
              (_templateObject5 = _taggedTemplateLiteral(["&nbsp"]))
          ...
          calendarEl.parentNode.replaceChild(newCalendar, calendarEl);
          statusEl.textContent = Sanitizer.escapeHTML(
            _templateObject6 ||
        ...
        var displayPreviousYearChunk = function displayPreviousYearChunk(el) {
          ...
          var newCalendar = displayYearSelection(
            calendarEl,
            cappedDate.getFullYear()
          );
          var nextToFocus = newCalendar.querySelector(
            CALENDAR_PREVIOUS_YEAR_CHUNK
          );
        ...
        var handleEscapeFromCalendar = function handleEscapeFromCalendar(
          event
        ) {
        ...
        var adjustMonthSelectionScreen = function adjustMonthSelectionScreen(
          adjustMonthFn
        ) {
          return function (event) {
            ...
            if (!isSameMonth(currentDate, cappedDate)) {
              var newCalendar = displayMonthSelection(
                calendarEl,
                cappedDate.getMonth()
              );
        ...
        var handleMouseoverFromMonth = function handleMouseoverFromMonth(
          monthEl
        ) {
          if (monthEl.disabled) return;
        ...
        var adjustYearSelectionScreen = function adjustYearSelectionScreen(
          adjustYearFn
        ) {
          return function (event) {
        ...
        var datePickerEvents =
          ...
          _defineProperty(
            ...
            CLICK,
            ((_CLICK = {}),
            _defineProperty(_CLICK, DATE_PICKER_BUTTON, function () {
              toggleCalendar(this);
            }),
          ...
          _defineProperty(
            _datePickerEvents,
            "keyup",
            _defineProperty({}, DATE_PICKER_CALENDAR, function (event) {
          ...
          _defineProperty(
            ...
            "focusout",
            ((_focusout = {}),
            _defineProperty(_focusout, DATE_PICKER_EXTERNAL_INPUT, function () {
              validateDateInput(this);
            }),
          ...
          _defineProperty(
            _datePickerEvents,
            "input",
            _defineProperty({}, DATE_PICKER_EXTERNAL_INPUT, function () {
    ...
    21: [
      function (require, module, exports) {
        ...
        var DATE_RANGE_PICKER_RANGE_START_CLASS = "".concat(
          DATE_RANGE_PICKER_CLASS,
          "__range-start"
        );
        var DATE_RANGE_PICKER_RANGE_END_CLASS = "".concat(
          DATE_RANGE_PICKER_CLASS,
          "__range-end"
        );
        var DATE_PICKER = ".".concat(DATE_PICKER_CLASS);
        var DATE_RANGE_PICKER = ".".concat(DATE_RANGE_PICKER_CLASS);
        var DATE_RANGE_PICKER_RANGE_START = ".".concat(
          DATE_RANGE_PICKER_RANGE_START_CLASS
        );
        var DATE_RANGE_PICKER_RANGE_END = ".".concat(
          DATE_RANGE_PICKER_RANGE_END_CLASS
        );
        var DEFAULT_MIN_DATE = "0000-01-01";
        /**
        ...
        var getDateRangePickerContext = function getDateRangePickerContext(el) {
          ...
          if (!dateRangePickerEl) {
            throw new Error(
              "Element is missing outer ".concat(DATE_RANGE_PICKER)
            );
          }

          var rangeStartEl = dateRangePickerEl.querySelector(
            DATE_RANGE_PICKER_RANGE_START
          );
          var rangeEndEl = dateRangePickerEl.querySelector(
        ...
        var enhanceDateRangePicker = function enhanceDateRangePicker(el) {
          ...
          if (!rangeStart) {
            throw new Error(
              ""
                .concat(DATE_RANGE_PICKER, " is missing inner two '")
                .concat(DATE_PICKER, "' elements")
            );
          }
          ...
          if (!rangeEnd) {
            throw new Error(
              ""
                .concat(DATE_RANGE_PICKER, " is missing second '")
                .concat(DATE_PICKER, "' element")
            );
          }
        ...
        var dateRangePicker = behavior(
          ...
          {
            init: function init(root) {
              selectOrMatches(DATE_RANGE_PICKER, root).forEach(function (
                dateRangePickerEl
              ) {
    ...
    22: [
      function (require, module, exports) {
        ...
        var PREVIEW_HEADING_CLASS = "".concat(
          PREFIX,
          "-file-input__preview-heading"
        );
        var DISABLED_CLASS = "".concat(PREFIX, "-file-input--disabled");
        var CHOOSE_CLASS = "".concat(PREFIX, "-file-input__choose");
        var ACCEPTED_FILE_MESSAGE_CLASS = "".concat(
          PREFIX,
          "-file-input__accepted-files-message"
        );
        ...
        var GENERIC_PREVIEW_CLASS_NAME = "".concat(
          PREFIX,
          "-file-input__preview-image"
        );
        var GENERIC_PREVIEW_CLASS = "".concat(
          GENERIC_PREVIEW_CLASS_NAME,
          "--generic"
        );
        var PDF_PREVIEW_CLASS = "".concat(GENERIC_PREVIEW_CLASS_NAME, "--pdf");
        var WORD_PREVIEW_CLASS = "".concat(
          GENERIC_PREVIEW_CLASS_NAME,
          "--word"
        );
        var VIDEO_PREVIEW_CLASS = "".concat(
          GENERIC_PREVIEW_CLASS_NAME,
          "--video"
        );
        var EXCEL_PREVIEW_CLASS = "".concat(
          GENERIC_PREVIEW_CLASS_NAME,
          "--excel"
        );
        var SPACER_GIF =
        ...
        var createUniqueID = function createUniqueID(name) {
          return ""
            .concat(name, "-")
            .concat(Math.floor(Date.now().toString() / 1000));
        };
        /**
        ...
        var buildFileInput = function buildFileInput(fileInputEl) {
          ...
          if (
            ...
            fileInputParent.querySelector(
              ".".concat(DRAG_TEXT_CLASS)
            ).outerHTML = "";
          }
        ...
        var removeOldPreviews = function removeOldPreviews(
          dropTarget,
          instructions,
          inputAriaLabel
        ) {
          var filePreviews = dropTarget.querySelectorAll(
            ".".concat(PREVIEW_CLASS)
          );
          var fileInputElement = dropTarget.querySelector(INPUT);
          var currentPreviewHeading = dropTarget.querySelector(
            ".".concat(PREVIEW_HEADING_CLASS)
          );
          var currentErrorMessage = dropTarget.querySelector(
            ".".concat(ACCEPTED_FILE_MESSAGE_CLASS)
          );
          /**
        ...
        var handleChange = function handleChange(
          ...
          var _loop = function _loop(i) {
            ...
            if (i === 0) {
              fileInputEl.setAttribute(
                "aria-label",
                "You have selected the file: ".concat(fileName)
              );
            } else if (i >= 1) {
              fileInputEl.setAttribute(
                "aria-label",
                "You have selected "
                  .concat(fileNames.length, " files: ")
                  .concat(fileStore.join(", "))
              );
              ...
              if (fileName.indexOf(".pdf") > 0) {
                previewImage.setAttribute(
                  ...
                  'this.onerror=null;this.src="'
                    .concat(SPACER_GIF, '"; this.classList.add("')
                    .concat(PDF_PREVIEW_CLASS, '")')
                );
              } else if (
        ...
        var preventInvalidFiles = function preventInvalidFiles(
          e,
          fileInputEl,
          instructions,
          dropTarget
    ...
    23: [
      function (require, module, exports) {
        ...
        var BUTTON = ""
          .concat(NAV, " .")
          .concat(PREFIX, "-footer__primary-link");
        ...
        function toggleHtmlTag(isMobile) {
          ...
          primaryLinks.forEach(function (currentElement) {
            ...
            newElement.classList.toggle(
              "".concat(PREFIX, "-footer__primary-link--button"),
              isMobile
            );
            ...
            if (isMobile) {
              var menuId = ""
                .concat(PREFIX, "-footer-menu-list-")
                .concat(Math.floor(Math.random() * 100000));
          ...
          _defineProperty({}, CLICK, _defineProperty({}, BUTTON, showPanel)),
          {
            ...
            init: function init() {
              ...
              this.mediaQueryList = window.matchMedia(
                "(max-width: ".concat(HIDE_MAX_WIDTH - 0.1, "px)")
              );
    ...
    24: [
      function (require, module, exports) {
        ...
        var NON_NAV_ELEMENTS = "body > *:not(".concat(
          HEADER,
          "):not([aria-hidden])"
        );
        ...
        var INITIAL_PADDING = window
          .getComputedStyle(document.body)
          .getPropertyValue("padding-right");
        var TEMPORARY_PADDING = "".concat(
        ...
        navigation = behavior(
          ...
          _defineProperty(
            ...
            _defineProperty(_CLICK, BODY, hideActiveNavDropdown),
          ...
          _defineProperty(
            _behavior,
            "focusout",
            _defineProperty({}, NAV_PRIMARY, function (event) {
          ...
          {
            init: function init(root) {
              var trapContainer = root.matches(NAV)
                ? root
      ...
      function (require, module, exports) {
        ...
        function setFocus(el) {
          el.closest(CONTAINER)
            .querySelector(".".concat(PREFIX, "-input"))
            .focus();
        }
        ...
        var inputPrefixSuffix = behavior(
          _defineProperty(
            {},
            CLICK,
            _defineProperty({}, DECORATION, function () {
              setFocus(this);
            })
          ),
          {
    ...
    26: [
      function (require, module, exports) {
        ...
        var CLOSE_BUTTON = ""
          .concat(WRAPPER_CLASSNAME, " *[")
          .concat(CLOSER_ATTRIBUTE, "]");
        var OPENERS = "*[".concat(OPENER_ATTRIBUTE, "][aria-controls]");
        var CLOSERS = ""
          .concat(CLOSE_BUTTON, ", .")
          .concat(OVERLAY_CLASSNAME, ":not([")
          .concat(FORCE_ACTION_ATTRIBUTE, "])");
        var NON_MODALS = "body > *:not(.".concat(
          WRAPPER_CLASSNAME,
          "):not([aria-hidden])"
        );
        ...
        function toggleModal(event) {
          ...
          var openFocusEl = targetModal.querySelector(INITIAL_FOCUS)
            ? targetModal.querySelector(INITIAL_FOCUS)
            : targetModal.querySelector(".usa-modal");
          var returnFocus = document.getElementById(
            targetModal.getAttribute("data-opener")
          );
          var menuButton = body.querySelector(OPENERS);
          var forceUserAction = targetModal.getAttribute(
          ...
          if (clickedElement) {
            ...
            if (clickedElement.closest(".".concat(MODAL_CLASSNAME))) {
              if (
                ...
                clickedElement.closest("[".concat(CLOSER_ATTRIBUTE, "]"))
              ) {
                // do nothing. move on.
              } else {
          ...
          if (safeActive && openFocusEl) {
            ...
            document
              .querySelectorAll(NON_MODALS_HIDDEN)
              .forEach(function (nonModal) {
        ...
        var setUpModal = function setUpModal(baseComponent) {
          ...
          var forceUserAction = baseComponent.hasAttribute(
            FORCE_ACTION_ATTRIBUTE
          )
          ...
          for (
            ...
            originalLocationPlaceHolder.setAttribute(
              "data-original-".concat(attribute.name),
              attribute.value
            );
          }
        ...
        var cleanUpModal = function cleanUpModal(baseComponent) {
          ...
          var originalLocationPlaceHolder = document.querySelector(
            '[data-placeholder-for="'.concat(modalID, '"]')
          );
        ...
        modal = {
          init: function init(root) {
            selectOrMatches(MODAL, root).forEach(function (modalWindow) {
              ...
              document
                .querySelectorAll('[aria-controls="'.concat(modalId, '"]'))
      ...
      function (require, module, exports) {
        ...
        var toggleSearch = function toggleSearch(button, active) {
          ...
          if (!form) {
            throw new Error(
              "No "
                .concat(FORM, " found for search toggle in ")
                .concat(CONTEXT, "!")
            );
          }
    ...
    28: [
      function (require, module, exports) {
        ...
        var LINK = "."
          .concat(PREFIX, '-skipnav[href^="#"], .')
          .concat(PREFIX, '-footer__return-to-top [href^="#"]');
    ...
    29: [
      function (require, module, exports) {
        ...
        var ANNOUNCEMENT_REGION = ".".concat(
          PREFIX,
          '-table__announcement-region[aria-live="polite"]'
        );
        ...
        var updateSortLabel = function updateSortLabel(header) {
          ...
          var isSorted =
            ...
            false;
          var headerLabel = ""
            .concat(headerName, "', sortable column, currently ")
            .concat(
              isSorted
                ? "".concat(
                    sortedAscending
                      ? "sorted ".concat(ASCENDING)
                      : "sorted ".concat(DESCENDING)
                  )
                : "unsorted"
            );
          var headerButtonLabel = "Click to sort by "
            .concat(headerName, " in ")
            .concat(sortedAscending ? DESCENDING : ASCENDING, " order.");
        ...
        var updateLiveRegion = function updateLiveRegion(table, sortedHeader) {
          ...
          if (liveRegion && liveRegion.matches(ANNOUNCEMENT_REGION)) {
            var sortAnnouncement = 'The table named "'
              .concat(caption, '" is now sorted by ')
              .concat(headerLabel, " in ")
              .concat(sortedAscending ? ASCENDING : DESCENDING, " order.");
        ...
        var toggleSort = function toggleSort(header, isAscending) {
          ...
          if (!table) {
            throw new Error(
              "".concat(SORTABLE_HEADER, " is missing outer ").concat(TABLE)
            );
          }
        ...
        var table = behavior(
          _defineProperty(
            {},
            CLICK,
            _defineProperty({}, SORT_BUTTON, function (event) {
              event.preventDefault();
              toggleSort(
      ...
      function (require, module, exports) {
        ...
        var transformTimePicker = function transformTimePicker(el) {
          ...
          for (var time = minTime; time <= maxTime; time += step) {
            ...
            option.value = ""
              .concat(padZeros(hour24, 2), ":")
              .concat(padZeros(minute, 2));
            option.text = ""
              .concat(hour12, ":")
              .concat(padZeros(minute, 2))
              .concat(ampm);
        ...
        var timePicker = behavior(
          ...
          {
            init: function init(root) {
              selectOrMatches(TIME_PICKER, root).forEach(function (
                timePickerEl
              ) {
    ...
    31: [
      function (require, module, exports) {
        ...
        var addListenerMulti = function addListenerMulti(
          element,
          eventNames,
          listener
        ) {
        ...
        var showToolTip = function showToolTip(
          ...
          var setPositionClass = function setPositionClass(setPos) {
            tooltipBody.classList.remove(
              "".concat(TOOLTIP_BODY_CLASS, "--top")
            );
            tooltipBody.classList.remove(
              "".concat(TOOLTIP_BODY_CLASS, "--bottom")
            );
            tooltipBody.classList.remove(
              "".concat(TOOLTIP_BODY_CLASS, "--right")
            );
            tooltipBody.classList.remove(
              "".concat(TOOLTIP_BODY_CLASS, "--left")
            );
            tooltipBody.classList.add(
              "".concat(TOOLTIP_BODY_CLASS, "--").concat(setPos)
            );
          };
          /**
          ...
          var calculateMarginOffset = function calculateMarginOffset(
            marginPosition,
            tooltipBodyOffset,
            trigger
          ) {
            var offset =
              offsetMargin(trigger, "margin-".concat(marginPosition)) > 0
                ? tooltipBodyOffset -
                  offsetMargin(trigger, "margin-".concat(marginPosition))
                : tooltipBodyOffset;
            return offset;
          };
          /**
          ...
          var positionTop = function positionTop(e) {
            ...
            e.style.margin = "-"
              .concat(topMargin, "px 0 0 -")
              .concat(leftMargin / 2, "px");
          };
          /**
    ...
    53: [
      function (require, module, exports) {
        ...
        module.exports = function (button, expanded) {
          ...
          if (!controls) {
            throw new Error(
              'No toggle target found with id: "'.concat(id, '"')
            );
          }
    ...
    54: [
      function (require, module, exports) {
        ...
        module.exports = function validate(el) {
          ...
          if (!checkList) {
            throw new Error(
              'No validation element found with id: "'.concat(id, '"')
            );
          }
          ...
          Object.entries(el.dataset).forEach(function (_ref) {
            ...
            if (key.startsWith("validate")) {
              ...
              var validatorSelector = '[data-validator="'.concat(
                validatorName,
                '"]'
              );
              ...
              if (!validatorCheckbox) {
                throw new Error(
                  'No validator checkbox found for: "'.concat(
                    validatorName,
                    '"'
                  )
                );
